...
--
-- Name: types_type_id_seq1; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.types_type_id_seq1 OWNER TO freecodecamp;

--
-- Name: types_type_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.types_type_id_seq1 OWNED BY public.types.type_id;
...
ALTER TABLE ONLY public.types ALTER COLUMN type_id SET DEFAULT nextval('public.types_type_id_seq1'::regclass);
...
--
-- Name: types_type_id_seq1; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.types_type_id_seq1', 1, false);
...
--
-- Name: types types_pkey1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.types
    ADD CONSTRAINT types_pkey1 PRIMARY KEY (type_id);
